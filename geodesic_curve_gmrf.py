...
An iterative MCMC based fourth-order Runge-Kutta algorithm for numerical 
simulation of Gaussian random fields' dynamics
...
def RK4(a, b, n, mean, variance, beta, alpha1, alpha2, alpha3):
	...
	return (mean_vector, variance_vector, beta_vector, alpha1_vector, alpha2_vector, alpha3_vector, geodesic_vector, entropy_vector, curvature_vector)
